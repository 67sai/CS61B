...
public class IntList {
  ...
  public static IntList dcatenate(IntList A, IntList B) {
    ...
    IntList p = A;    //变量p设置为指向与A相同的IntList对象
    while (p.rest != null) {  //遍历链表
      p = p.rest;
    }
    p.rest = B;
    return A;
  ...
  public static IntList catenate(IntList A, IntList B) {
    ...
    IntList T = new IntList(A.first, null);
    IntList p = T;
    A = A.rest;
    while (A != null) {
   ...
   * <p>
   * If there is no cycle, the number 0 is returned instead. This is a utility method for lab2. You
   * are not expected to read, understand, or even use this method. The point of this method is so
   * that if you convert an IntList into a String and that IntList has a loop, your computer doesn't
